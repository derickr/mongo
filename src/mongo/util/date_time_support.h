...
public:
    ...
    /**
     * A custom-deleter which destructs a _timelib_time* when it goes out of scope.
     */
...
public:
    ...
    /**
     * A custom-deleter which destructs a _timelib_error_container* when it goes out of scope.
     */
